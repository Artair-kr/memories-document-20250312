...
CREATE TABLE IF NOT EXISTS `memories`.`user` (
  ...
  `sns_id` VARCHAR(100) NULL COMMENT 'OAuth 인증 후  인증 서버로부터 발급 받은 사용자 아이디',
...
CREATE TABLE IF NOT EXISTS `memories`.`diary` (
  `diary_number` INT NOT NULL AUTO_INCREMENT COMMENT '일기 작성 번호',
